# -*- coding: utf-8 -*-
# Generated by Django 1.11.20 on 2019-02-17 10:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('orders', models.ManyToManyField(related_name='user', to='app.Order')),
                ('visited_pages', models.ManyToManyField(related_name='interested', to='app.Pages')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='review',
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reviewed', to='app.User'),
        ),
        migrations.AddField(
            model_name='product',
            name='reviews',
            field=models.ManyToManyField(related_name='product', to='app.Review'),
        ),
        migrations.AddField(
            model_name='product',
            name='tags',
